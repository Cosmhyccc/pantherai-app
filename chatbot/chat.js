...
window.debugChatLoading = async function() {
    ...
    // Add debug button for subscription issues
    ...
    function renderChatHistory() {
        ...
        console.log(`Current session: ${currentSessionId}, history items: ${chatHistory.length}`);
    ...
    if (session && session.user) {
        // Load chat history from database and render sidebar
